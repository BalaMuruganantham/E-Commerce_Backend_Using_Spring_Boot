package com.balacode.balacart.seed;
	...
	public void run(String... args) throws Exception {
		if(productRepository.count()==0) {
			List<Product> demoProducts = List.of(
					new Product(null, "Apple iPhone 15", 799.0, "SmartPhone with A16 Chip", "Electronics", 4.8, "Amazon", 5, List.of("products/1.jpg")),
					new Product(null, "Samsung Galaxy S23", 749.0, "Flagship Android with Snapdragon 8 Gen 2", "Electronics", 4.7, "Flipkart", 8, List.of("products/2.jpg")),
					...
					new Product(null, "OnePlus 11", 699.0, "Flagship killer with Snapdragon 8 Gen 2", "Electronics", 4.6, "Amazon", 6, List.of("products/7.jpg")),
					...
					new Product(null, "Google Pixel 7", 649.0, "Clean Android experience with Tensor chip", "Electronics", 4.5, "Flipkart", 7, List.of("products/10.jpg"))
					);
		productRepository.saveAll(demoProducts);
		System.out.print("✅ Seeded demo products");
		} else {
			System.out.print("Products Already there. Skip seed");
		}
